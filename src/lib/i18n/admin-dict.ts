...
const ms = {
  ...
  password_hint: "Sekurang-kurangnya {min} aksara.",
  ...
  password_weak_sameAsUsername: "Tidak boleh sama dengan nama pengguna.",
  password_weak_common: "Terlalu biasa dan mudah diteka.",
  password_weak_lowVariety: "Terlalu sedikit variasi aksara.",
  password_weak_repeatedChar: "Tidak boleh aksara yang sama diulang sahaja.",
  password_weak_sequence: "Tidak boleh jujukan mudah seperti 12345678.",
  ...
  confirm_deleteTitle: "Padam item ini?",
  confirm_typeToProceed: 'Taip "{phrase}" untuk mengesahkan',
  wc_resetConfirmTitle: "Kembalikan semua tetapan?",
  wc_resetPhrase: "KEMBALIKAN",
  nav_menu: "Menu",
  nav_language: "Bahasa",
  ...
  music_deleteActiveTitle: "Trek ini sedang aktif",
...
const en: Record<keyof typeof ms, string> = {
  ...
  password_weak_sameAsUsername: "Cannot be the same as the username.",
  password_weak_common: "Too common and easy to guess.",
  password_weak_lowVariety: "Too few different characters.",
  password_weak_repeatedChar: "Cannot be one repeated character.",
  password_weak_sequence: "Cannot be a simple sequence like 12345678.",
  ...
  confirm_deleteTitle: "Delete this item?",
  confirm_typeToProceed: 'Type "{phrase}" to confirm',
  wc_resetConfirmTitle: "Restore all settings?",
  wc_resetPhrase: "RESTORE",
  nav_menu: "Menu",
  ...
  music_deleteActiveTitle: "This track is currently active",
