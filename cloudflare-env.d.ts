/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 8db2ebc671ad0b1055f1a3b844806d51)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS_BUCKET: R2Bucket;
	wedding_card_assets: R2Bucket;
	DB: D1Database;
	wedding_card_db: D1Database;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANALYTICS_SALT" | "CRON_SECRET" | "MAILJET_API_KEY" | "MAILJET_API_SECRET" | "MAILJET_SENDER_EMAIL" | "MAILJET_SENDER_NAME" | "SITE_URL">> {}
}
